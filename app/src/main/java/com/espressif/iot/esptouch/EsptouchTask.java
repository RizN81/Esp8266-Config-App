...
public class EsptouchTask implements IEsptouchTask {
	...
	public  com.espressif.iot.esptouch.task.EsptouchTask _mEsptouchTask;
	...
	public EsptouchTask(String apSsid, String apBssid, String apPassword, Context context) {
		...
		_mEsptouchTask = new com.espressif.iot.esptouch.task.EsptouchTask(apSsid, apBssid, apPassword,
